...
INITIAL_PROMPT = """
오버워치 탱커 영웅 및 스킬:
디바: 매트릭스, 매트, 부스터, 미사일, 자폭, 메카호출, 리멕, 슬램
도미나: 방벽배열, 소닉리펄서, 수정발사, 판옵티콘
둠피스트: 로켓펀치, 펀치, 지진강타, 슬램, 파워블락, 블락, 미티어, 파멸의일격
해저드: 스파이크가드, 덤벼들기, 가시벽, 가시소나기, 다운포어
정커퀸: 나이프, 톱니칼, 샤웃, 지휘의외침, 카네지, 램페지
마우가: 돌파, 오버런, 심장, 케이지
오리사: 재블린, 포티파이, 골드, 스핀, 서지
라마트라: 공허방벽, 네메시스, 볼텍스, 절멸
라인하르트: 망치, 해머, 방벽, 돌진, 핀, 화염강타, 불줄기, 쉐터, 대지분쇄, 어스
로드호그: 갈고리, 훅, 숨돌리기, 돼재앙
시그마: 방벽, 그래스프, 강착, 락, 플럭스, 플럭, 자탄, 그래비틱플럭스
윈스턴: 레일건, 점프팩, 팩, 리프, 버블, 프라이멀
레킹볼: 갈고리, 구르기, 파일드라이버, 슬램, 마인필드, 마인
자리야: 버블, 프렌들리버블, 개인버블, 자탄, 그랩, 중력자탄

오버워치 딜러 영웅 및 스킬:
안란: 맹염질주, 춤추는불꽃, 불사조승천
애쉬: 다이너마이트, 코치건, 밥
바스티온: 수색모드, 강습모드, 네이드, 캐논
캐서디: 연사, 팬, 자력수류탄, 네이드, 석양, 하이눈, 데드아이
에코: 점착폭탄, 스티키, 비행, 빔, 복제
엠레: 사이버파편, 사이펀블라스터
프레야: 퀵대시, 상승기류, 올가미사격
겐지: 질풍참, 대시, 스위프, 스위프트스트라이크, 디플랙트, 디플, 튕겨내기, 용검, 검, 블레이드
한조: 음파화살, 소나, 폭풍화살, 스톰, 용의일격, 드래곤
정크랫: 충격지뢰, 컨커션, 강철덫, 트랩, 타이어
메이: 아이스블락, 블락, 빙벽, 월, 눈보라, 블리자드
파라: 점프, 젯, 젯팩, 충격탄, 콩, 바라지, 포화
리퍼: 망령화, 랩, 그림자밟기, 섀도, 블로썸, 죽음의꽃
소전: 레일건, 원샷, 파워슬라이드, 슬라, 분열사격, 슬로, 오버클럭
솔저76: 헬릭스, 헬릭, 나선로켓, 힐팩, 질주, 스프린트, 생체장, 바이저
솜브라: 해킹, 인비즈, 은신, EMP
시메트라: 감시포탑, 순간이동기, TP, 광자방벽
토르비욘: 포탑, 과부하, 초고열용광로
트레이서: 블링크, 블링, 점멸, 리콜, 시간역행, 펄스, 펄스폭탄
벤처: 잠복, 드릴돌진, 지각충격
위도우메이커: 갈고리, 훅, 맹독지뢰, 마인, 적외선투시

오버워치 서포터 영웅 및 스킬:
라이프위버: 연꽃단상, 플랫, 구원의손길, 풀, 생명의나무, 트리
루시우: 밀쳐내기, 붑, 분위기전환, 크로스페이드, 엠프, 스피, 비트, 소리방벽
메르시: 공격력강화, 데미지부스트, 힐, 수호천사, GA, 부활, 레즈, 발키리
모이라: 소멸, 페이드, 생체구슬, 오브, 융화, 코얼레선스
바티스트: 이모탈, 불사장치, 재생폭발물, 증폭매트릭스, 윈도우
브리기테: 방패밀치기, 채찍질, 플레일, 랠리
아나: 수면총, 슬립, 생체수류탄, 그네, 힐밴, 보라, 나노, 뽕
키리코: 호부, 카드, 정화의방울, 방울, 여우길, 길
젠야타: 화합, 화합의구슬, 불화, 불화의구슬, 마크, 초월
일리아리: 태양포탑, 치유의불꽃, 궤도광선, 궤도
주노: 하이퍼링, 링, 궤도광선
미즈키: 치유삿갓, 종이인형, 결계성역

궁극기 별칭:
비트, 나노, 뽕, 자탄, 그랩, 석양, 하이눈, 펄스, 길, 키츠네, 윈도우, 랠리, 타이어, 망치, 자폭, 리필, 오버클럭, 궤도, 아쎄이투하, 블로썸, 드래곤, 바라지, 케이지, 미티어, 프라이멀, 절멸, 융화, 발키리, 초월, 쉐터, 램페지, 슬램

게임 용어:
궁체크, 궁극기, 한타, 포커싱, 포지션, 딜각, 양각, 템포, 턴, 리그룹, 플랭킹, 포킹, 피킹, 변수, 밸류, 베이팅, 러쉬, 사이드, 본대, 앵커, 홀딩, 리테이크, 궁분배, 이니시, 전진수비, 훼이크, 이속, 어그로, 딜교환, 투멘딜, 라인전

체력 용어:
피1, 개피, 딸피, 반피, 힐밴, 힐, 케어, 태그드, 바디샷, 헤드샷

위치 용어:
고지대, 하이그라운드, 2층, 3층, 오른쪽, 왼쪽, 정면, 골목, 아치, 입구, 캣워크, 발코니, 터널, 거점, 화물, 리스폰

선수 이름 (한글):
에이드, 희상, 치요, 준빈, 심플, 스토커, 제스트, 벨로스레아, 초롱, 비질란테, 썸원, 한빈, 맥스, 베르나르, 자스민, 선준, 프라우드, 메리트, 제우, 루키, 유민, 낙지, 준빈, 선준, 민기, 필더, 체크메이트, 나인케이, 정크벅

선수 이름 (영어):
Aide, Heesung, ChiYo, Joonbin, Smurf, Stalk3r, Jest, Velosorea, Chorong, Vigilante, Someone, Hanbin, Max, Bernard, Jasmine, Seonjoon, Proud, Merit, MER1T, Checkmate, Zeus, Rookie, Daewoo, Youmin, Nakji, Dungbin, Seojun, Seonyu, Minki, Fielder, NineK, Junkbuck, SP9RK1E
"""
MERGE_GAP_SEC = 1.5
MERGE_MAX_SEC = 10.0
